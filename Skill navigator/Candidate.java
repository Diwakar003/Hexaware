...
public class Candidate {
    ...
    private String linkedInProfile; // Correct method names: camel case with no spaces
    ...
    public String getLinkedInProfile() { return linkedInProfile; }  // Corrected
    public void setLinkedInProfile(String linkedInProfile) { this.linkedInProfile = linkedInProfile; }  // Corrected

    public String getGitHubProfile() { return gitHubProfile; }  // Corrected
    public void setGitHubProfile(String gitHubProfile) { this.gitHubProfile = gitHubProfile; }  // Corrected
